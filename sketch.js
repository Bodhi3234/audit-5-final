...
function preload(){
    ...
    start = loadImage("sprites/Controls.png");
    win = loadImage("sprites/youWin.png");
    lose = loadImage("sprites/youLose.png");
}
function setup(){
